...
final class DNSFilter: @unchecked Sendable {
    ...
    func startFiltering() {
        ...
        queue.async { [weak self] in
            ...
            // Start block page server (for direct IP access)
            BlockPageServer.shared.start()

            // Start proxy server (like Zscaler - intercepts all browser traffic)
    ...
    func stopFiltering() {
        ...
        queue.async { [weak self] in
            ...
            // Stop proxy server (restores system proxy settings)
